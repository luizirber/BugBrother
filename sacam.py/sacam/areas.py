...
class Point(object):
    ''' Simple class that store data needed to generate reports.
        ...
        point (end_time - start_time) and in which areas the point
        is contained. '''
    ...
    def __repr__(self):
        return str( "(" + str(self.x_pos) + ", " + str(self.y_pos) + \
                    ") start: " + str(self.start_time) + " end: " \
                    + str(self.end_time))
